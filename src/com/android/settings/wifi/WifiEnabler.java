...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener, Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener  {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        //Do nothing if called as a result of a state machine event
        if (mStateMachineEvent/* || (Boolean)newValue == mSwitch.isChecked()*/) {
            return false;
        }

        //Just update switch if not user click.
        if ((Boolean)newValue == mSwitch.isChecked()) {
            return true;
        }
